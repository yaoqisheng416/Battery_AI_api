...
from core.task_manager import append_log, set_finished, set_failed, update_progress, set_running
from services.stage6_cbd_generate_service import generate_cbd_service
from services.stege6_cbd_fit_service import fit_cbd_w_service


# ============================================
# CBD 生成
# ============================================
def run_stage6_cbd_generate_task(
    task_id,
    request_data,
):
...
def run_stage6_cbd_fit_task(
    ...
    try:
        ...
        append_log(task_id, "Stage6 fit_cbd_spreading_parameter 开始执行")
        ...
        # finished
        # ============================================
        append_log(task_id, "Stage6 fit_cbd_spreading_parameter 执行完成")
